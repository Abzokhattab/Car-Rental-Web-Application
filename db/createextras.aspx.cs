    ...
    public partial class WebForm36 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Response.Redirect("createextras.aspx");
                }

                using (SqlConnection sqlCon = new SqlConnection(connectionString))
                {
                    sqlCon.Open();
                    SqlCommand sqlcmd = new SqlCommand("CreateExtra", sqlCon);
                    sqlcmd.CommandType = CommandType.StoredProcedure;
                    sqlcmd.Parameters.AddWithValue("@extra", TextBox1.Text);
                    sqlcmd.Parameters.AddWithValue("@rate", TextBox2.Text);
