<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewallcars.aspx.cs" Inherits="db.WebForm25" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\CarRentalDB.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="viewCars" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
